...
function tabDisplayTitle(tab: TabMeta): string {
  ...
  if (tab.scope === "global") return title || "独立工作区";
...
function tabFullTitle(tab: TabMeta): string {
  ...
  if (tab.scope === "global") {
    ...
    const workspaceName = tab.workspaceName?.trim() || "独立工作区";
      ...
      <div className="tabbar__tabs">
        {tabs.map((tab) => {
          ...
          const stateTitle = [
            ...
            toolApprovalMode === "yolo" ? "Full access" : "",
          ].filter(Boolean).join(" · ");
          ...
          return (
            ...
            >
              ...
              {toolApprovalMode === "yolo" && <span className="tabbar__mode-badge tabbar__mode-badge--yolo">full</span>}
              <span
