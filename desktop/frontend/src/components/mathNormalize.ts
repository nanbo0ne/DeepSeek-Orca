...
const DM = "__ORCA_MATH_DISPLAY__";
const IM = "__ORCA_MATH_INLINE__";
const LB = "__ORCA_LATEX_LINEBREAK__";
const DOLLAR = "&#36;";
...
function unusedPlaceholderPrefix(s: string): string {
  let prefix = "__ORCA_PROTECTED_CODE__";
  let n = 0;
  while (s.includes(prefix)) {
    n += 1;
    prefix = `__ORCA_PROTECTED_CODE_${n}__`;
  }
  return prefix;
}
