...
const STORAGE_KEY = "deepseek-orca-lang";

// currentLocale mirrors the active locale for callers outside React (lib/tools.ts).
let currentLocale: Locale = "en";

// Neutral status words shown while a turn is running. Keep these formal and short
// because they are visible in the composer action area.
