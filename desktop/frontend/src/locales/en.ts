...
export const en = {
  ...
  "composer.promptMode.assistant.help": "Uses the Orca general assistant prompt and assistant-mode memory.",
  "composer.promptMode.normal": "Normal",
  "composer.promptMode.normal.help": "Uses the current normal mode structure.",
  "composer.promptMode.enhanced": "Enhanced",
  "composer.promptMode.enhanced.help": "Uses the current enhanced mode structure for higher quality with more token cost.",
  ...
  "settings.fontFamilyComic": "Comic Sans",
