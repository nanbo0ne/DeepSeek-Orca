...
export const en = {
  ...
  "settings.uiScaleAuto": "Follow Windows",
  "settings.uiScaleHint": "The default uses Windows display scaling without adding another zoom. Manual values are relative to the system scale.",
