...
export const en = {
  ...
  "settings.uiScaleAuto": "Automatic",
  "settings.uiScaleHint": "Automatic mode follows the current display's logical work area. Interface scale and text size are independent.",
