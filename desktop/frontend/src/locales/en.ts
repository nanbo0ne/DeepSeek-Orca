...
export const en = {
  ...
  "toolLibrary.threadManagementDesc": "Expose thread_list for saved DeepSeek-Orca conversation topics.",
  ...
  "composer.enhancedMode": "Enhanced",
  "composer.enhancedModeHelp": "Improves answer quality, but may use more tokens and reduce cache hits.",
  ...
  "composer.promptMode.normal": "Normal",
  "composer.promptMode.normal.help": "For regular chat, lookups, and routine tasks with quicker responses.",
  "composer.promptMode.enhanced": "Enhanced",
  "composer.promptMode.enhanced.help": "For complex code, long tasks, and higher-quality reasoning with more tokens.",
  "composer.enhancedSwitchConfirmTitle": "Switch enhanced mode?",
  "composer.enhancedSwitchConfirmMessage": "This conversation is already over 50,000 tokens.",
  "composer.enhancedSwitchConfirmDetail": "Switching mid-conversation may miss the cache and may not let the model perform at its best.",
  ...
  "memory.profile.sharedAgent": "Normal/Enhanced",
  ...
  "memory.clearAssistant.detail": "Only the assistant profile is deleted. Normal/Enhanced memories and instruction files are not affected.",
  ...
  "settings.processDisplayHint": "Changes how reasoning and tool activity is shown without changing the final answer.",
  "settings.processDisplay.compact": "Compact",
  "settings.processDisplay.standard": "Standard",
  "settings.processDisplay.detailed": "Detailed",
  "settings.visionEnabled": "Multimodal vision",
  "settings.visionEnabledHint": "When enabled, attached images are uploaded to the current model provider. The model itself must support image input.",
  ...
  "process.timeline.elapsed": "Processed for {elapsed}",
  ...
  "settings.botWorkspaceRootDefault": "Leave empty to use DeepSeek-Orca's default bot-workspace",
  ...
  "update.download": "Version {version} is available. Open the official download page",
