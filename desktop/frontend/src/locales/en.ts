...
export const en = {
  ...
  "composer.promptMode.assistant.help": "For everyday Q&A, chat, and light help with Orca assistant memory.",
  ...
  "settings.fontFamilyFangSong": "FangSong",
  "settings.fontFamilyKaiTi": "KaiTi",
