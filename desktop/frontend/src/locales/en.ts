...
export const en = {
  ...
  "settings.botInstallSubtitle": "Choose a channel, then finish authorization or use the manual setup entry.",
  ...
  "settings.style.graphite.desc": "Paper white, graphite text, and DeepSeek blue accents — restrained, editor-like workbench.",
  ...
  "settings.style.pop.zh": "Pop Paint",
  "settings.style.pop.note": "Lively",
  "settings.style.pop.desc": "Candy pastels, neon highlights, and graffiti-paint energy for a brighter, game-like workspace.",
