...
export const zh: Record<DictKey, string> = {
  ...
  "composer.enhancedModeHelp": "提升模型回答质量，但可能产生更多 token消耗并降低缓存命中率；切换模式会导致缓存失效",
  ...
  "composer.promptMode.normal": "普通模式",
  "composer.promptMode.normal.help": "适合常规对话、查询和普通任务，响应更轻快。",
  "composer.promptMode.enhanced": "增强模式",
  "composer.promptMode.enhanced.help": "适合复杂代码、长任务和高质量推理，可能消耗更多 token。",
  ...
  "memory.profile.sharedAgent": "普通/增强",
  ...
  "memory.clearAssistant.detail": "只会删除助手模式分区，不影响普通/增强模式记忆和指令文件。",
  ...
  "settings.processDisplayHint": "只调整思考与工具过程的呈现，不改变最终回答内容。",
  ...
  "process.timeline.elapsed": "已处理 {elapsed}",
  ...
  "settings.uiScaleAuto": "跟随 Windows",
  "settings.uiScaleHint": "默认沿用 Windows 的显示缩放，不再额外缩放界面；手动倍率是在系统缩放基础上的相对调整。",
  ...
  "update.download": "有新版本 {version}，打开官方下载页面",
