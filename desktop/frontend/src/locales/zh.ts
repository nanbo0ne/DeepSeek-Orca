...
export const zh: Record<DictKey, string> = {
  ...
  "composer.promptMode.assistant.help": "使用 Orca 通用助手提示词与助手模式专属记忆。",
  "composer.promptMode.normal": "普通模式",
  "composer.promptMode.normal.help": "沿用当前普通模式结构。",
  "composer.promptMode.enhanced": "增强模式",
  "composer.promptMode.enhanced.help": "沿用当前增强模式结构，提升回答质量但可能增加 token 消耗。",
