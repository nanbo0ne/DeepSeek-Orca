...
func main() {
	flag.Usage = func() {
		fmt.Fprintf(flag.CommandLine.Output(), "e2ebench — O.R.C.A end-to-end benchmark.\n\n")
	...
	bin := flag.String("bin", "orca", "path to the orca binary")
...
func render(results []result) string {
	...
	fmt.Fprintf(&b, "## 🤖 O.R.C.A e2e benchmark\n\n")
