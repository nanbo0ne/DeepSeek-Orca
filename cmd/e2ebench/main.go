...
func main() {
	flag.Usage = func() {
		fmt.Fprintf(flag.CommandLine.Output(), "e2ebench — DeepSeek-Orca end-to-end benchmark.\n\n")
	...
	bin := flag.String("bin", "deepseek-orca", "path to the deepseek-orca binary")
...
func render(results []result) string {
	...
	fmt.Fprintf(&b, "## 🤖 DeepSeek-Orca e2e benchmark\n\n")
