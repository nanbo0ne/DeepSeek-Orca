...
func TestComposeAppendsAfterBase(t *testing.T) {
	base := "BASE PROMPT"
	set := &Set{Docs: []Source{{Path: "/p/DEEPSEEK_ORCA.md", Scope: ScopeProject, Body: "Use tabs."}}}
	got := Compose(base, set)
...
func TestDiscoverPrecedenceOrder(t *testing.T) {
	...
	mustWrite(t, filepath.Join(user, "DEEPSEEK_ORCA.md"), "USER LEVEL")
	mustWrite(t, filepath.Join(proj, "DEEPSEEK_ORCA.md"), "PROJECT LEVEL")
	mustWrite(t, filepath.Join(proj, "DEEPSEEK_ORCA.local.md"), "LOCAL LEVEL")
...
func TestImportResolution(t *testing.T) {
	...
	mustWrite(t, filepath.Join(proj, "DEEPSEEK_ORCA.md"), "Top line\n@shared.md\nBottom line")
...
func TestImportCycleDoesNotHang(t *testing.T) {
	...
	mustWrite(t, filepath.Join(proj, "DEEPSEEK_ORCA.md"), "@a.md")
...
func TestImportDiamondAndCycle(t *testing.T) {
	...
	mustWrite(t, filepath.Join(projCycle, "DEEPSEEK_ORCA.md"), "@cycle1.md")
