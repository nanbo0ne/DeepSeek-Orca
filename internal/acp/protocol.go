...
// to drive O.R.C.A. Many tools integrated with the v1 (main-branch) agent over
...
// older map shape that O.R.C.A v1 clients used.
...
// SessionListResult is the first and only page of sessions O.R.C.A currently
