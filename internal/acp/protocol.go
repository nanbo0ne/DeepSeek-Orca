...
// to drive DeepCode. Many tools integrated with the v1 (main-branch) agent over
...
// older map shape that DeepCode v1 clients used.
...
// SessionListResult is the first and only page of sessions DeepCode currently
