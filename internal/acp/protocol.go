...
// to drive DeepSeek-Orca. Many tools integrated with the v1 (main-branch) agent over
...
// older map shape that DeepSeek-Orca v1 clients used.
...
// SessionListResult is the first and only page of sessions DeepSeek-Orca currently
