// Package netclient builds HTTP clients and proxy resolvers that share DeepCode's
...
// NewHTTPClient returns an HTTP client with DeepCode proxy settings applied.
