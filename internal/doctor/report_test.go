...
func TestCollectReportRedactsSecrets(t *testing.T) {
	t.Setenv("DEEPSEEK_ORCA_TEST_SECRET", "sk-live-secret")
	...
	cfg.Providers = []config.ProviderEntry{{
		...
		Model:     "model-a",
		APIKeyEnv: "DEEPSEEK_ORCA_TEST_SECRET",
	}}
...
func TestRenderTextSurfacesWarningsUpTop(t *testing.T) {
	text := RenderText(Report{Warnings: []string{"config deepseek-orca.toml: parse boom"}})
